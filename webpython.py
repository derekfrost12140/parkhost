...
# Redis connection and queue setup for background processing
redis_url = os.getenv('REDIS_URL', 'redis://localhost:6379')
redis_conn = Redis.from_url(redis_url)
rq_queue = RQQueue(connection=redis_conn)

# Local queue for storing processed frames
...
def select_lot():
    ...
    rq_queue.enqueue(process_video, selected_video_path)
